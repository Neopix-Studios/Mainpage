    ...
    <AnimatePresence>
      {isVisible && (
        <motion.nav
          ...
          className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-5 text-white transition-colors duration-500 ${
            isAtTop ? 'bg-transparent' : 'bg-black/50 backdrop-blur-md shadow-lg border-b border-white/10'
          }`}
        >
          {/* Logo Container (Left) */}
